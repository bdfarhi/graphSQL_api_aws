...
var ServerlessAppsyncPlugin = /** @class */ (function () {
    function ServerlessAppsyncPlugin(serverless, options, utils) {
        var _this = this;
        ...
        this.hooks = {
            ...
            'appsync:validate-schema:run': function () {
                ...
                _this.utils.log.success('AppSync schema valid');
            },
                    ...
                    case 2:
                        ...
                        if (this.options.output) {
                            try {
                                ...
                                this.utils.log.success("Introspection schema exported to ".concat(filePath));
                            }
                            catch (error) {
                                this.utils.log.error("Could not save to file: ".concat(error.message));
                            }
                            return [2 /*return*/];
                        }
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        events === null || events === void 0 ? void 0 : events.forEach(function (event) {
                            ...
                            _this.utils.writeText("".concat(chalk_1.default.gray(luxon_1.DateTime.fromMillis(timestamp || 0).toISO()), "\t").concat(message));
                        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.utils.log.warning('You are using the CloudFormation integration for domain configuration.\n' +
    ...
    ServerlessAppsyncPlugin.prototype.getDomainCertificateArn = function () {
        return __awaiter(this, void 0, void 0, function () {
            var CertificateSummaryList, domain, matches, _loop_1, this_1, _i, matches_1, match, state_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (match) {
                            ...
                            if (cert) {
                                this_1.utils.log.info("Found matching certificate for ".concat(match, ": ").concat(cert.CertificateArn));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        this.utils.log.success("Domain '".concat(domain.name, "' created successfully"));
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _b.sent();
                        if (error_1 instanceof this.serverless.classes.Error &&
                            this.options.quiet) {
                            this.utils.log.error(error_1.message);
                        }
                        else {
                            throw error_1;
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        domain = this.getDomain();
                        this.utils.log.warning("The domain '".concat(domain.name, " will be deleted."));
                        _a = !this.options.yes;
                        if (!_a) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, utils_1.confirmAction)()];
                    case 1:
                    ...
                    case 3:
                        _b.sent();
                        this.utils.log.success("Domain '".concat(domain.name, "' deleted successfully"));
                        return [3 /*break*/, 5];
                    case 4:
                        error_2 = _b.sent();
                        if (error_2 instanceof this.serverless.classes.Error &&
                            this.options.quiet) {
                            this.utils.log.error(error_2.message);
                        }
                        else {
                            throw error_2;
                        }
    ...
    ServerlessAppsyncPlugin.prototype.showApiAssocStatus = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        progressInstance = this.utils.progress.create({ message: message });
                        _c.label = 1;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.utils.log.warning("The domain ".concat(domain.name, " is currently associated to another API (").concat(assoc === null || assoc === void 0 ? void 0 : assoc.apiId, ")"));
                        _a = !this.options.yes;
                    ...
                    case 8:
                        _b.sent();
                        this.utils.log.success("API successfully associated to domain '".concat(domain.name, "'"));
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if ((assoc === null || assoc === void 0 ? void 0 : assoc.associationStatus) === 'NOT_FOUND') {
                            this.utils.log.warning("The domain ".concat(domain.name, " is currently not associated to any API"));
                            return [2 /*return*/];
                        }
                        ...
                        this.utils.log.warning("The domain ".concat(domain.name, " will be disassociated from API '").concat(apiId, "'"));
                        _a = !this.options.yes;
                        if (!_a) return [3 /*break*/, 4];
                        return [4 /*yield*/, (0, utils_1.confirmAction)()];
                    case 3:
                    ...
                    case 6:
                        _b.sent();
                        this.utils.log.success("API successfully disassociated from domain '".concat(domain.name, "'"));
                        return [2 /*return*/];
                }
            });
        });
    ...
    ServerlessAppsyncPlugin.prototype.createRecord = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        progressInstance = this.utils.progress.create({
                    ...
                    case 4:
                        _a.sent();
                        progressInstance.remove();
                        this.utils.log.info("Alias record for '".concat(domain.name, "' was created in Hosted Zone '").concat(hostedZoneId, "'"));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.utils.log.warning("Alias record for '".concat(domain.name, "' will be deleted from Hosted Zone '").concat(hostedZoneId, "'"));
                        _a = !this.options.yes;
                        if (!_a) return [3 /*break*/, 4];
                        return [4 /*yield*/, (0, utils_1.confirmAction)()];
                    case 3:
                    ...
                    case 6:
                        _b.sent();
                        progressInstance.remove();
                        this.utils.log.info("Alias record for '".concat(domain.name, "' was deleted from Hosted Zone '").concat(hostedZoneId, "'"));
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (error_4 instanceof this.serverless.classes.Error &&
                            this.options.quiet) {
                            this.utils.log.error(error_4.message);
                        }
                        else {
                            throw error_4;
                        }
